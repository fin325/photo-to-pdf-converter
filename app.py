...
st.markdown("""
    <style>
    /* Подключаем шрифт Montserrat для кнопок */
    ...
    /* ИКОНКА ДОКУМЕНТА (Листочек) */
    div[data-testid="stFileUploader"] svg {
        fill: #1A3A5F !important;
    }

    /* ТОЛЬКО КРЕСТИК УДАЛЕНИЯ — Увеличенный и Бордовый */
...
# Колонки для размещения описания справа от загрузчика
col_uploader, col_info = st.columns([1.8, 1])
...
with col_info:
    st.markdown(f"""
        <div class="description-text">
            ...
            Загрузите ваши фотографии (JPG или PNG).<br>
            <strong>🚀 Шаг 2:</strong><br>
            Нажмите кнопку ниже для создания PDF.
        </div>
    """, unsafe_allow_html=True)
